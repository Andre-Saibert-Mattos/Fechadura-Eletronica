...
struct EstruturaBancoDados {  // 8byte
  ...
  char Tipo;      // Indica se o ID é de um Usuario ou Administrador, "0" ou "1".
};
...
void exportarBanco(){
  ...
  String IDScript = "AKfycbwLWVeYzSRPj----------J0fRtULLr7tp_iL"; // ID Gerado no Scrip quando configurado
  ...
  if (!client.connect("script.google.com", 443)){
    ...
    // Constroi o HTTP
    String sendDados = "GET https://script.google.com/macros/s/"+IDScript+"/exec?"; 
    bool aux=true;
    int i=0;
    int k=0;
    do{
...
void importarBanco(){
  ...
  String IdPlanilha = "1MxFd5vjC------HqTcRtD0CAhQ";    // ID da planilhas google onde sera o seu banco de dados
  String ChaveAPI = "AIzaSyBx------ZuWUjc3cHk";   // Chave API para a leitura dos dados da planilha
